...
/******************************************************************************/
#define LCD_CONTROL_PORT_REG    GPIO_PORTB_DATA_R
#define LCD_CONTROL_PORT_ID     GPIO_PORTB
#define LCD_EN                  PIN5                    /*GPIO_B5*/
#define LCD_RS                  PIN7                    /*GPIO_B7*/
...
/******************************************************************************/
void LCD_vidMoveCursor(uint8_t local_u8column,uint8_t local_u8row);
...
/******************************************************************************/
void LCD_vidWriteNumber (uint16_t local_u16num );
