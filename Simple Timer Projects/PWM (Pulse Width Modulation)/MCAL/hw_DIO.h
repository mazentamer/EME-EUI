 ...
 *      Version:  1.00
 *
 *  Description:  GPIO registers with convenient accessing using function-like macros
 *
 *********************************************************************************************************************/
...
#define GPIO_PORT_AFSEL(port_id)            (*((volatile uint32 *)(0x40004420 + ((port_id)*0x1000))))
